$(document).ready(function() {
  ...
  // Adding click event on the right margin
  $(".flipbook").on("click", function(event) {
    var offset = $(this).offset();
    var width = $(this).width();
    
    // Check if the click is on the right margin (adjust the threshold as needed)
    if (event.pageX > offset.left + width - 50) { // 50px from the right edge
      $(this).turn('previous'); // Go to the previous page
    }
  });
